...
export const aboutContent = {
  intro: ["I'm Kitsakorn! (he/him)", 'Thank you for visiting this website.'],
  mission: [
    'ผมชื่อ"นิว"และนี่คือพื้นที่ที่ผมใช้แสดงความคิดสร้างสรรค์และแรงบันดาลใจ ถ้ามีอะไรอยากพูดคุย หรือกำลังมองหาใครสักคนที่จะช่วยใน การออกแบบ, การเขียนโค้ด ผมยินดีรับฟัง!',
    'สามารถติดต่อผมได้ที่ "เเก้ว" ตรงหน้าเเรกเลย"',
  ],
  testimonials: [
    {
      quote:
