    ...
    <>
      <DefaultSeo
        ...
        openGraph={{
          ...
          images: [
            {
              url: 'https://kitsxkorn.xyz/images/social.png',
              width: 2333,
              height: 1313,
              alt: 'kitsxkorn.xyz wordmark over colorful, crudely scribbled illustration of laptop displaying another crudely drawn illustration of a laptop.',
              type: 'image/png',
            },
          ],
          site_name: 'kitsxkorn.xyz',
        }}
        twitter={{
